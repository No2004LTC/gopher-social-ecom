...
func NewInteractionUsecase(repo domain.InteractionRepository, notiUC domain.NotificationUsecase, mq domain.MessageQueue) domain.InteractionUsecase {
...
func (u *interactionUsecase) ToggleLike(ctx context.Context, userID, postID int64) (bool, error) {
	...
	if u.mq != nil {
		err = u.mq.PublishInteractionEvent(ctx, event)
		if err != nil {
